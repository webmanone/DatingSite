...
?>
    ...
    <form action="signupInc.php" method="post">
        ...
        <div><input type="date" name="birthday" placeholder="Date of birth:">
        <input type="text" name="location" placeholder="Location..."></div>
        <div><input type="text" name="email" placeholder="Email...">
            <input type="tel" name="phone" placeholder="Phone Number..." pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required></div>
        <div><input type="password" name="pwd" placeholder="Password...">
             <input type="password" name="pwdrepeat" placeholder="Repeat password..."></div>
